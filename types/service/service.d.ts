...
export declare function controller(name: string | symbol | ControllerOption): (target: any, _?: ClassDecoratorContext) => void;
export declare function controller(name?: string | symbol, options?: ControllerOption): (target: any, _?: ClassDecoratorContext) => void;
