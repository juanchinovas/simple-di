...
exports.loadControllers = exports.connect = exports.trace = exports.option = exports.head = exports.patch = exports.put = exports.del = exports.post = exports.get = exports.controller = void 0;
...
function loadControllers(callbackFn) {
    const controllerMap = (0, container_1.getContainer)().get("service::controllers::map");
    if (callbackFn) {
